...
// antes del render van las funciones
{
  ...
  insertarProfesor = () =>
  {
    ...
    fetch ('http://192.168.0.17/APImatriculasGrupoSabado/modelo/insertarProfesor.php',
    {
      method:'POST',
      headers:{
...
render()
  {
    return(
      <View style={MisEstilos.MainContainer}>
       <View>
        <Text style= {{fontSize: 20, textAlign: 'center', fontWeight: 'bold'}}>Registo de profesor</Text>
        ...
        <TextInput
        placeholder="Ingrese el id del dpto"
        onChangeText = {TextInputValue =>  this.setState
        ({
